...
import creditLight from '../assets/blue-credit-light-mode.webp';
import creditDark from '../assets/yellow-credit-dark-mode.webp';
  ...
  return (
    <footer className="w-full bg-bg rounded-t-[2.5rem] overflow-hidden flex flex-col">
      ...
      <div className="relative z-20 w-full pt-16 pb-0 flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 lg:gap-6 items-start">
          
          {/* Column 1: Brand & Socials */}
          <div className="flex flex-col items-start lg:col-span-1 min-w-max order-last lg:order-none">
            <h3 className="w-max font-heading text-[50px] font-[800] text-[#007BFF] dark:text-[#FFD722] leading-[0.95] tracking-tight pr-2 pb-2 mb-1 mt-0">
              Vansh<br/>Digitals
            </h3>
            ...
            <p className="mt-12 font-body text-[11px] text-text-muted leading-tight">
                ...
                {[
                  ...
                  return (
                    <a 
                      ...
                      className="group relative flex items-center gap-3 outline-none cursor-pointer"
                    ...
                    >
                      <div 
                        className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-text-muted group-hover:text-[#087EFF] dark:group-hover:text-brand-yellow group-hover:border-brand-blue dark:group-hover:border-brand-yellow transition-colors group-focus-visible:ring-2 group-focus-visible:ring-brand-blue dark:group-focus-visible:ring-brand-yellow z-10 bg-[#FAFAF7] dark:bg-bg"
                        aria-hidden="true"
                      >
                        <item.icon size={16} />
                      </div>
                      ...
                      <span 
                        className="font-body text-[15px] font-medium text-text-primary z-10 transition-colors"
                      >
                        {item.name}
                      </span>
                      ...
                      <div 
                        className={`absolute top-[110%] left-0 mt-1 md:top-1/2 md:-translate-y-1/2 md:left-[110px] md:mt-0 bg-white dark:bg-[#1C1C1F] border border-[#E6E6E3] dark:border-border shadow-sm rounded-lg px-3 py-2 transition-all duration-200 ease-out z-20 md:origin-left
                        ${isExpanded 
                          ? 'opacity-100 translate-y-0 md:translate-x-0 pointer-events-auto' 
                          : 'opacity-0 -translate-y-1 md:translate-y-[-50%] md:-translate-x-2 pointer-events-none'
