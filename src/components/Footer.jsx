    ...
    <footer className="w-full bg-bg rounded-t-[2.5rem] overflow-hidden flex flex-col">
      ...
      >
        ...
        >
          ...
          <div 
            ref={baseTextRef}
            className="font-heading font-[800] tracking-[-0.08em] md:tracking-tighter whitespace-nowrap text-[#111214]/[0.04] dark:text-white/[0.05] text-[31vw] md:text-[clamp(200px,34vw,850px)]"
          >
            VANSH
          </div>
          ...
          <div 
            className="absolute inset-0 font-heading font-[800] tracking-[-0.08em] md:tracking-tighter whitespace-nowrap text-transparent bg-clip-text pointer-events-none dark:hidden animate-ink-fluid text-[31vw] md:text-[clamp(200px,34vw,850px)]"
            style={{ 
          ...
          <div 
            className="absolute inset-0 font-heading font-[800] tracking-[-0.08em] md:tracking-tighter whitespace-nowrap text-transparent bg-clip-text pointer-events-none hidden dark:block animate-ink-fluid text-[31vw] md:text-[clamp(200px,34vw,850px)]"
            style={{ 
              backgroundSize: '250% 250%, 300% 300%, 200% 200%, 350% 350%',
              backgroundImage: `
